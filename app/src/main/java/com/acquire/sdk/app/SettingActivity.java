...
//                setLayoutColor(envelope);
            switch (picker) {
                ...
                case 2:
                    ...
                    if (AcquireApp.getInstance() != null) AcquireApp.getInstance().setMaskingViewColor(maskColor);
    ...
    public void saveCOB(View view) {
        ...
        success.observe(this, aBoolean -> {
            if (aBoolean) {
                // Getting values from the App
                Toast.makeText(SettingActivity.this, "Cobrowse Settings Saved\nPlease wait...", Toast.LENGTH_SHORT).show();
                ...
                CoBrowse.CobrowseBuilder cobrowseBuilder =
                        new CoBrowse.CobrowseBuilder().setMAX_UPDATE_TIME(maxUpdateTime).setMIN_UPDATE_TIME(minUpdateTime)
                                .setBITMAP_QUALITY(bitmapQuality).setHideStopButton(swStopBtn.isChecked()).setConfirmStop(swConfirm.isChecked());
                if (!CobCode.isEmpty()) {
                ...
                AcquireApp.initCobrowse(SettingActivity.this.getApplication(), AppComponent.AccID, cobrowse);
    ...
    public void saveFAB(View view) {
        ...
        success.observe(this, aBoolean -> {
            if (aBoolean) {
                Toast.makeText(SettingActivity.this, "FAB Settings Saved\nPlease wait...", Toast.LENGTH_SHORT).show();

                if (((CheckBox) findViewById(R.id.cbDefautFAB)).isChecked()) {
                    AcquireApp.supportFAB = null;
                    AcquireApp.setShowDefaultFAB(true);
                    AcquireApp.init(SettingActivity.this.getApplication(), AppComponent.AccID);
                    return;
                }
                // Getting values from the App
                ...
                supportFABBuilder.setFabSize(fabSize).setFabIconPosition(fabPOs == 0 ? BOTTOM_LEFT : BOTTOM_RIGHT)
